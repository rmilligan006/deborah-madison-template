...
const Navbar = () => {
  ...
  return (
    <div className="absolute top-0 z-50 w-full h-[50px] flex flex-row justify-around items-center p-20 bg-[#857B6A]">
      ...
      {/*Desktop Menu */}
      <ul className="hidden md:flex m-2 text-[#857B6A]">
        <li className="pl-4 text-sm focus:active:font-bold">
          <Link to="/">About</Link>
        </li>
        <li className="pl-5 text-sm cursor-pointer">
          <Link to="/books">Books</Link>
        </li>
        <li className="pl-5 text-sm focus:active:font-bold">
          <Link to="/calendar">Calendar</Link>
        </li>
        <li className="pl-5 text-sm">
